...
const SectionTitle: React.FC<{ className?: string }> = ({ className = "" }) => {
  ...
  return (
    <div
      ref={container}
      className={cn(
        "my-[0.2em] flex text-[26px] sm:text-[34px] md:text-[43px] lg:text-[51px] xl:text-[60px] 2xl:text-[68px]",
        className,
      )}
    >
      <h2
      ...
      >
        Collaboration <br /> story
      </h2>
      <RiArrowRightDownLine className="-mt-[0.1em] text-[1.4em]" />
    </div>
  );
};
