...
export const updateCustomerProfile = async (
  ...
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/customer/${customerId}?field=profile`, {
      method: 'PATCH',
...
export const updateCustomerEmail = async (
  ...
  try {
    console.log('Updating customer email with data:', { newEmail, currentPassword: '***' });
    const response = await fetch(`${API_BASE_URL}/customer/${customerId}?field=email`, {
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
...
export const updateCustomerUsername = async (
  ...
  try {
    console.log('Updating customer username with data:', { newUsername, currentPassword: '***' });
    const response = await fetch(`${API_BASE_URL}/customer/${customerId}?field=username`, {
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
...
export const updateCustomerPassword = async (
  ...
  try {
    console.log('Updating customer password with data:', { currentPassword: '***', newPassword: '***' });
    const response = await fetch(`${API_BASE_URL}/customer/${customerId}?field=password`, {
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
...
export const updateCustomerPhone = async (
  ...
  try {
    console.log('Updating customer phone with data:', { phoneNumber, currentPassword: '***' });
    const response = await fetch(`${API_BASE_URL}/customer/${customerId}?field=phoneNo`, {
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ phoneNo: phoneNumber, password: currentPassword }),
    });
    ...
    if (!response.ok) {
      throw new Error(result.message ?? 'Failed to update customer phone number');
    }
...
export const updateCustomerAddress = async (
  ...
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/customer/${customerId}?field=address`, {
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
